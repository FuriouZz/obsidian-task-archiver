/** biome-ignore-all lint/complexity/noStaticOnlyClass: Copy/Paste from task plugin https://github.com/obsidian-tasks-group/obsidian-tasks/blob/65f296fd84cd294ecb04cd6017167fc8f3d8caf7/src/Task/TaskRegularExpressions.ts */
